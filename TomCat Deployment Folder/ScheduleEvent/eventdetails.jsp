...
<table>
			...
			<td><input id="txt_EventName" name="txt_EventName" type="text"   title="Please Enter The Event Name"></td>
			</tr>
			<tr>
			<td><label >Event Description</label></td>
			<td><input id="txt_EventDescription" name="txt_EventDescription" type="text"   title="Enter The Event Description." ></td>
			</tr>
			<tr>
		...
		<%}} %>
			...
			<td><input id="EventDate" name="EventDate" type="text" title="Enter The Event Date "></td>
			</tr>
			<tr>
			<td colspan="2">&nbsp;</td>
				</tr>
				...
				<input type="hidden" name="addParam" value="addEvent">
